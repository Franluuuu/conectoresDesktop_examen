...
public class MainJFrame extends javax.swing.JFrame {
            ...
            new Thread(action + " " + j) {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        var clientes = ClienteRepository.get(s);
            ...
            new Thread(action + " " + j) {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        var cliente = ClienteRepository.find(s, id);
            ...
            new Thread(action + " " + j) {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        ClienteRepository.insert(s, cliente);
            ...
            new Thread(action + " " + j) {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        var query = s.createStoredProcedureCall("ContarClientesP");

                        query.registerParameter("search", String.class, ParameterMode.IN);
                        query.registerParameter("total", Integer.class, ParameterMode.OUT);

                        query.setParameter("search", jTFValor.getText());

                        query.execute();

                        var total = (Integer) query.getOutputParameterValue("total");
    ...
    private void jBScriptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBScriptActionPerformed
        ...
        try {
            ...
            // TODO: Buscar otra forma de lanzar un script
            log(pre + "TODO: Buscar otra forma de lanzar un script");
